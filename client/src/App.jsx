    ...
    <div className="landingPage">
      ...
      <main>
        ...
        <section className="pricingSection" id="tarife">
          <div className="sectionIntro"><span>TARIFE</span><h2>Für den einzelnen Mieter. Und für ganze Verwaltungen.</h2><p>Privat bleibt einfach. Verwaltungen können den vollständigen Team-Arbeitsbereich 14 Tage testen; konkrete Europreise werden erst angezeigt, sobald sie verbindlich festgelegt sind.</p></div>
