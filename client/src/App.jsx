...
function CaseDetail({ caseId, onBack, onUpdated, user, onProfile }) {
  ...
  return (
    <div className="workspacePage detailPage">
      ...
      <AssignmentPanel caseId={caseId} item={item} onChanged={async()=>{await load();onUpdated();}} /><CaseTasksPanel caseId={caseId}/>
