...
function NewCase({ onClose, onCreated }) {
  ...
  const [form, setForm] = useState({ title:'',caseContext:'housing',category:categories[0],description:'',propertyLabel:'',locationLabel:'',subjectLabel:'',referenceLabel:'',counterpartyType:'',discoveredOn:today,recipientName:'',recipientEmail:'',recipientAddress:'',deadlineOn:'',destinationLinkId:'' });
  const [busy, setBusy] = useState(false);
  const [error, setError] = useState('');
